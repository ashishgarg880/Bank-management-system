...
ResultSet rs;
Statement st;
    private Object jInternalFrame1;
  ...
  public void connect(){
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("CREATE ACOOUNT");

        jLabel1.setText("NAME");

        jLabel2.setText("ADHAAR CARD NUMBER");
      ...
      String g= jTextArea1.getText();
       ...
       try{
            ...
            if (c.equals("")& a.equals(""))
            {
                ...
                String cmd="INSERT INTO profile(name,adhaar_no,email,date,month,year,mobile_no,address) values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+h+"','"+g+"')";
