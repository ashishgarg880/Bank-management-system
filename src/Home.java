...
Statement st;
    ...
    JOptionPane.showMessageDialog(this,"PLEASE CHECK THE CONNECTIUON");
  }
    ...
    private void initComponents() {
        ...
        jInternalFrame1.setBackground(new java.awt.Color(51, 0, 255));
        jInternalFrame1.setClosable(true);
        jInternalFrame1.setMaximizable(true);
        jInternalFrame1.setTitle("HOME PAGE");
        jInternalFrame1.setVisible(true);

        jMenu1.setText("File");

        jMenuItem1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_MASK));
        jMenuItem1.setText("CREATE A PROFILE");
        ...
        jMenuItem5.setText("Saving Account");
        ...
        jMenuItem6.setText("Current Account");
